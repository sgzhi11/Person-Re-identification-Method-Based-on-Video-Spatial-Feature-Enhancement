...
class STAM(nn.Module):
    ...
    def forward(self, feat_map):
        ...
        reshape_map = feat_map.view(b * t, c, h, w) # 128,1024,16,8
        ...
        # gap_feat_map = self.conv_block(gap_feat_map) # 128,1024,16,8
        ATT = SLD(1024, 1024).cuda()
        gap_feat_map = ATT(gap_feat_map)
